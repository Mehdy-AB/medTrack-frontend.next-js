// Encadrant/PageEvaluations/components/SearchBarEvaluations.tsx
...
interface SearchBarEvaluationsProps {
  onSearch: (value: string) => void;
}

const SearchBarEvaluations = ({ onSearch }: SearchBarEvaluationsProps) => {
