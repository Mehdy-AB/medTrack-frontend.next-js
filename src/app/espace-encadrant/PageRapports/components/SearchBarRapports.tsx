...
interface SearchBarRapportsProps {
  onSearch: (value: string) => void;
}

const SearchBarRapports = ({ onSearch }: SearchBarRapportsProps) => {
  ...
  return (
    <div className="relative w-full max-w-xl">
      ...
      <input
        ...
        placeholder="Rechercher par nom étudiant, stage ou type de rapport..."
...
export default SearchBarRapports;