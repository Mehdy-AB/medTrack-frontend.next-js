// Encadrant/PageListe/components/SearchBarListe.tsx
...
interface SearchBarListeProps {
  onSearch: (value: string) => void;
}

const SearchBarListe = ({ onSearch }: SearchBarListeProps) => {
