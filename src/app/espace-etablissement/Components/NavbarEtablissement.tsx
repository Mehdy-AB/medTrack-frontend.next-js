...
const NavbarEtablissement = () => {
  const [activeLink, setActiveLink] = useState('espace-etablissement');
        ...
        <div className="flex items-center h-20 justify-between">
          ...
          <div className="hidden md:flex items-center space-x-4">
            <div className="flex items-center space-x-3 px-4 py-2 rounded-full bg-gray-50 border border-gray-200">
              ...
              <span className="text-sm font-medium text-gray-700">Établissement</span>
            </div>
          </div>
...
export default NavbarEtablissement;